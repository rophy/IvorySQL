...
**Analysis**: IvorySQL rejects values below 2000 with an error. Oracle silently adjusts values below 2000 up to 2000 (the minimum). See [Issue #22](https://github.com/rophy/IvorySQL/issues/22).
...
### Test 9.2: Exceeding max line length (32768 bytes via PUT)

**IvorySQL**:
```
Test 9.2 (32768 via PUT): OK
```
...
**Analysis**: IvorySQL does not enforce the 32767 byte line length limit. Oracle raises ORU-10028.

---

### Test 9.3: Large line (50000 bytes via PUT)

**IvorySQL**:
```
Test 9.3 (50000 via PUT): OK
```
...
**Analysis**: See [Issue #21](https://github.com/rophy/IvorySQL/issues/21) for tracking.
...
| Section 9: Line length limits | 3 | 1 | 2 |
| **Total** | **33** | **27** | **6** |

**Compatibility Rate**: 82% (27/33 tests)
...
| 4.1 | Should silently adjust to 2000, not reject | Low | [Issue #22](https://github.com/rophy/IvorySQL/issues/22) |
| 4.4 | Maximum buffer 1000000 vs unlimited | Low | Document difference |
| 9.2, 9.3 | No 32767 byte line length limit | Medium | [Issue #21](https://github.com/rophy/IvorySQL/issues/21) |
