...
PG_KEYWORD("collation", K_COLLATION)
...
PG_KEYWORD("parallel_enable", K_PARALLEL_ENABLE)
...
PG_KEYWORD("pipelined", K_PIPELINED)
...
PG_KEYWORD("relies_on", K_RELIES_ON)
PG_KEYWORD("result_cache", K_RESULT_CACHE)
